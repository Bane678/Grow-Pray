...
const styles = StyleSheet.create({
  ...
  counterArabic: { fontSize: 28, color: '#e8e0d6', marginBottom: 6, fontFamily: FONTS.arabic },
  ...
  itemArabic: { fontSize: 26, color: '#e8e0d6', textAlign: 'right', lineHeight: 44, marginBottom: 8, fontFamily: FONTS.arabic },
